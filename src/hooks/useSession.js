...
/*
 * Сценарии:
 * - локальный токен ок - устанавливаем сессию
 * - локальный токен протух - ресет сессии
 * - логаут - ресет сессии
 * - логин - установить новую сессию
 *
 * */
...
export const useSession = () => {
  ...
  return { isLoggedIn, user, token, loading, onLogin, onLogout };
};
